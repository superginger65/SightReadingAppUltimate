  ...
  function generateMelody(keyName, meter, difficulty, numMeasures) {
    ...
    for (let m = 0; m < numMeasures; m++) {
      ...
      if (isLast) {
        ...
        const pattern = Math.floor(seededRandom() * 8);
        let finalNotes;
        switch (pattern) {
          ...
          case 3: // SSSS + Q on tonic (tied when tonic = str3)
            ...
            break;
          case 4: // SSSS + EE arpeggiation (no 16ths on last beat)
            finalNotes = [
              { pitch: str4, duration: 0.25, isRest: false },
              { pitch: str3, duration: 0.25, isRest: false },
              { pitch: str2, duration: 0.25, isRest: false },
            ...
            break;
          case 5: // Half note on bass (E)
            finalNotes = [{ pitch: str4, duration: 2, isRest: false }];
            break;
