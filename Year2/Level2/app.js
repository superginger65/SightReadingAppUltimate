...
// Year 2 Level 2 — A Minor & E Minor, single-line melodies
...
(function () {
  ...
  // Year 2 Level 2 — A minor & E minor (harmonic minor: raised 7th only)
  // Am: A3–D5, pitches A B C D E F G# (no natural G)
  // Em: E3–B4, pitches E F# G A B C D# (no natural D)
  const KEY_DEFS = {
  ...
  function generateMelody(keyName, meter, difficulty, numMeasures) {
    ...
    // Pick start pitch randomly from the level's allowed start pitches
    ...
    for (let m = 0; m < numMeasures; m++) {
      ...
      for (let n = 0; n < rhythm.length; n++) {
        ...
        if (isLast) {
          ...
          // Cadence: penultimate note approaches the final tonic
  ...
  const MIDI_SAMPLE_MAP = {
    52: "audio/E.mp3",           // E3
    54: "audio/Fs-Gb.wav",       // F#3
    55: "audio/G.mp3",           // G3
    57: "audio/A.mp3",           // A3
    59: "audio/B.mp3",           // B3
    60: "audio/C1.mp3",          // C4
    62: "audio/D1.wav",          // D4
    63: "audio/Ds1-Eb1.wav",     // D#4
    64: "audio/E1.wav",          // E4
    65: "audio/F1.wav",          // F4
    66: "audio/Fs1-Gb1.mp3",     // F#4
    67: "audio/G1.wav",          // G4
    68: "audio/Gs1-Ab1.mp3",     // G#4
    69: "audio/A1.wav",          // A4
    71: "audio/B1.mp3",          // B4
    72: "audio/C2.wav",          // C5
    74: "audio/D2.wav",          // D5
  ...
  const SCORE_HISTORY_KEY = "sightreading-score-history-year2-level2";
