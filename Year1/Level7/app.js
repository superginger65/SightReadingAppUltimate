...
(function () {
  ...
  // Level 7 — E-flat major only, range Eb4–D5
  const KEY_DEFS = {
    "Eb": { tonic: 51, mode: "major", abcKey: "Eb", usesFlats: true,
            allowedPitches: [63, 65, 67, 68, 70, 72, 74] },
  };
  ...
  const SCORE_HISTORY_KEY = "sightreading-score-history-year1-level7";
