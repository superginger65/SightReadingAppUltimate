...
(function () {
  ...
  // Level 6 — F major and D minor, range D4–G5
  const KEY_DEFS = {
    ...
    "Dm": { tonic: 62, mode: "minor", abcKey: "Dm", usesFlats: true,
            allowedPitches: [62, 64, 65, 67, 69, 70, 72, 73, 74, 76, 77, 79] },
  };
  ...
  const SCORE_HISTORY_KEY = "sightreading-score-history-year1-level6";
